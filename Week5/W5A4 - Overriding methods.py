class Person:
    ...
    def showDetails(self):
        print("\nSuperclass display:")
        print(f"{self.name}, age {self.age}, lives at {self.address}")
...
class Staff(Person):
    ...
    def showDetails(self):
        print("\nSubclass display:")
        print(f"{self.name}, age {self.age}, lives at {self.address}")
        print(f"{self.name} has tax code {self.taxcode} at {self.payrate} hourly pay rate")
...
if __name__ == "__main__":
    ...
    # this is showDetails() of the superclass
    person1.showDetails()
    ...
    # this is showDetails() of the subclass
    staff1.showDetails()
